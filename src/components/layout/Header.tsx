        ...
        <Container className="flex justify-between items-center">
          <div className="flex items-center gap-4">
            <div className="flex gap-3">
              <a href="#" className="hover:text-brand-accent transition-colors"><Globe className="w-4 h-4" /></a>
            ...
            >
              <Container className="py-8">
                <form onSubmit={handleSearch} className="relative max-w-3xl mx-auto">
                  ...
                  <button type="submit" className="absolute right-4 top-1/2 -translate-y-1/2 bg-brand-primary text-white px-6 py-2.5 rounded-xl font-black text-[10px] uppercase tracking-widest hover:bg-brand-ink transition-all">
                    {t('common.find') || 'Найти'}
                  </button>
                </form>
              </Container>
