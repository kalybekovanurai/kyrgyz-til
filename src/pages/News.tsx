  ...
  return (
    <div className="flex flex-col w-full min-h-screen bg-slate-50">
            ...
            <div className="flex flex-wrap gap-2 md:gap-3">
              {categories.map((cat) => (
                <button 
                  ...
                  className={cn(
                    'px-5 md:px-6 py-2 md:py-2.5 rounded-full text-[9px] md:text-[10px] font-black uppercase tracking-widest transition-all',
      ...
      <Container className="py-12 md:py-20">
        {loading && (
          <div className="rounded-2xl bg-white p-8 text-sm font-bold text-gray-400">
