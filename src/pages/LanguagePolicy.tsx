    ...
    return (<div className="flex flex-col w-full min-h-screen bg-slate-50">
      ...
      <div className="container mx-auto px-4 py-20">
        <div className="max-w-5xl mx-auto">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="bg-white p-10 md:p-16 rounded-[3rem] shadow-sm border border-gray-100 mb-12 relative overflow-hidden">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-20">
            <motion.div initial={{ opacity: 0, x: -20 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} className="bg-white p-12 rounded-[3.5rem] border border-gray-100 shadow-sm group hover:shadow-xl transition-all">
            ...
            <motion.div initial={{ opacity: 0, x: 20 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} className="bg-brand-primary p-12 rounded-[3.5rem] shadow-xl shadow-brand-primary/20 text-white relative overflow-hidden group">
          ...
          <div className="bg-white p-12 md:p-16 rounded-[4rem] border border-gray-100 shadow-sm text-center">
             ...
             <Link to="/contact#form" className="cursor-pointer bg-slate-50 text-brand-primary font-black px-12 py-5 rounded-sm border border-gray-100 hover:border-brand-primary transition-all text-xs uppercase tracking-widest inline-block">
