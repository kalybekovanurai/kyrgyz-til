      ...
      <div className="container mx-auto px-4 py-24">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          {partners.map((partner, idx) => (
            <motion.div 
              ...
              className="group bg-white p-12 rounded-[2.5rem] border border-gray-100 shadow-sm hover:shadow-2xl transition-all flex flex-col items-center text-center justify-between min-h-[400px]"
            >
              ...
              <button className="flex items-center gap-3 text-[10px] font-black uppercase tracking-widest text-brand-primary group-hover:translate-x-1 transition-transform mt-10">
        ...
        <div className="mt-24 p-12 md:p-20 bg-brand-primary rounded-[3rem] text-white text-center relative overflow-hidden">
           <div className="relative z-10">
             ...
             <Link to="/contact#form" className="bg-white text-brand-primary px-12 py-5 rounded-sm font-black text-[11px] uppercase tracking-widest hover:bg-brand-ink hover:text-white transition-all inline-block">
               {t('partners.cta.btn')}
             </Link>
           </div>
